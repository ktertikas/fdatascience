...
ws.onmessage = function(event) {
    ...
    mockdata_arr = [1704.648,1766.856,1522.408,1471.296,1694.776,1630.12,1823.36,1964.528,1964.528,1578.888,1827.792,1878.712,1933.52,1635.512,1735.848,1964.528,1361.136,1487.064,1854.368,1512.536,1772.248,1782.288,1788.016,1866.976,1571.816,1256.68,1823.36,1543.376,1806.632,2036.608];
    console.log("mockdata_arr.length: "+mockdata_arr.length);
    min_mockdata_arr = Math.min.apply(null,mockdata_arr);
    console.log("min: "+min_mockdata_arr);
    max_mockdata_arr = Math.max.apply(null,mockdata_arr)
    console.log("max: "+max_mockdata_arr);
    numbins = 20;

    var bins = d3.layout.histogram()    // create layout object
    .bins(numbins)   // to use 20 bins
    .range([min_mockdata_arr, max_mockdata_arr])    // to cover range from 0 to 1
    (mockdata_arr); // group the data into the bins
